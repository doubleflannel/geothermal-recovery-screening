...
This folder holds sanitized artifacts for the public geothermal thermal-recovery
screening framework. The current included figures are for the Brady/PoroTomo
featured verified example.
...
- static PNG/PDF/sanitized HTML screenshots;
- small public-source-derived snippets only if needed for provenance.
